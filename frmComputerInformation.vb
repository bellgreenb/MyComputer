Public Class frmComputerInformation

    Dim totalMemory As Decimal
    Dim availableMemory As Decimal

    Private Sub fromComputerInformation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblDisplayCPUName.Text = My.Computer.Registry.GetValue("HKEY_LOCAL_MACHINE\HARDWARE\DESCRIPTION\SYSTEM\CentralProcessor\0", "ProcessorNameString", Nothing).ToString
